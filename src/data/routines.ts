...
export const routines: Routine[] = [
  ...
  // ── Equipment Focused Quick Routines ────────────────────────────────
  {
    slug: "kettlebell-quick-win",
    name: "Kettlebell Quick-Win",
    tagline: "18 minutes. One bell. Full body.",
    category: "quick",
    daysPerWeek: 3,
    equipment: ["kettlebell"],
    difficulty: "intermediate",
    totalMinPerSession: 18,
    targetMuscles: ["glutes", "hamstrings", "shoulders", "lats", "quads", "hamstrings"],
    days: [
      {
        dayLabel: "Kettlebell Circuit",
        focus: "Full-body power and conditioning",
        blocks: [
          {
            label: "Warm-up",
            items: [
              { ref: "cat-cow", refKind: "stretch", holdSec: 8 },
              {
                ref: "kettlebell-halo",
                refKind: "exercise",
                sets: 1,
      ...
      },
          {
            label: "Main",
            items: [
              { ref: "kettlebell-swing", refKind: "exercise", sets: 3, reps: "15" },
              { ref: "kettlebell-clean", refKind: "exercise", sets: 3, reps: "5 per side" },
              { ref: "kettlebell-overhead-press", refKind: "exercise", sets: 3, reps: "5 per side" },
              { ref: "kettlebell-gorilla-row", refKind: "exercise", sets: 2, reps: "6 per side" },
            ],
      },
          {
            label: "Cooldown",
            items: [
              { ref: "doorway-pec-stretch", refKind: "stretch", holdSec: 30 },
              { ref: "cross-body-shoulder-stretch", refKind: "stretch", holdSec: 30 },
              { ref: "childs-pose", refKind: "stretch", holdSec: 45 },
            ],
      },
        ],
  ...
  {
    slug: "one-dumbbell-fifteen",
    name: "One Dumbbell, 15 Minutes",
    tagline: "Full body in 15 minutes with a single dumbbell.",
    category: "quick",
    daysPerWeek: 3,
    equipment: ["dumbbells"],
    difficulty: "beginner",
    totalMinPerSession: 15,
    targetMuscles: ["chest", "quads", "hamstrings", "lats", "shoulders", "hamstrings"],
    days: [
      {
        dayLabel: "Single Dumbbell Full-Body",
        focus: "Time-efficient strength and muscle",
        blocks: [
          {
            label: "Warm-up",
            items: [
              { ref: "cat-cow", refKind: "stretch", holdSec: 8 },
              { ref: "standing-quad-stretch", refKind: "stretch", holdSec: 20 },
            ],
      },
          {
            label: "Main",
            items: [
              { ref: "dumbbell-thruster", refKind: "exercise", sets: 3, reps: "8" },
              { ref: "dumbbell-floor-press", refKind: "exercise", sets: 3, reps: "10" },
              { ref: "renegade-row", refKind: "exercise", sets: 3, reps: "6 per side" },
              { ref: "dumbbell-step-up", refKind: "exercise", sets: 2, reps: "8 per leg" },
            ],
      },
          {
            label: "Cooldown",
            items: [
              { ref: "kneeling-hip-flexor-stretch", refKind: "stretch", holdSec: 30 },
              { ref: "figure-four-stretch", refKind: "stretch", holdSec: 45 },
              { ref: "childs-pose", refKind: "stretch", holdSec: 45 },
            ],
      },
        ],
  ...
  {
    slug: "band-only-blitz",
    name: "Band-Only Blitz",
    tagline: "Full body, zero setup, all bands.",
    category: "quick",
    daysPerWeek: 3,
    equipment: ["bands"],
    difficulty: "beginner",
    totalMinPerSession: 15,
    targetMuscles: ["lats", "shoulders", "quads", "hamstrings", "abs"],
    days: [
      {
        dayLabel: "Resistance Band Circuit",
        focus: "Joint-friendly full-body conditioning",
        blocks: [
          {
            label: "Warm-up",
            items: [
              { ref: "cat-cow", refKind: "stretch", holdSec: 8 },
              { ref: "band-face-pull", refKind: "exercise", sets: 1, reps: "15" },
            ],
      },
          {
            label: "Main",
            items: [
              { ref: "band-squat", refKind: "exercise", sets: 3, reps: "15" },
              { ref: "band-row", refKind: "exercise", sets: 3, reps: "12" },
              { ref: "band-overhead-press", refKind: "exercise", sets: 2, reps: "12" },
              { ref: "band-pallof-press", refKind: "exercise", sets: 2, reps: "10 per side" },
            ],
      },
          {
            label: "Cooldown",
            items: [
              { ref: "thread-the-needle", refKind: "stretch", holdSec: 30 },
              { ref: "doorway-pec-stretch", refKind: "stretch", holdSec: 30 },
              { ref: "downward-dog", refKind: "stretch", holdSec: 45 },
            ],
      },
        ],
        totalMin: 15,
  ...
  {
    slug: "bar-only-back-builder",
    name: "Bar-Only Back Builder",
    tagline: "Build back and grip strength with just a pull-up bar.",
    category: "quick",
    daysPerWeek: 2,
    ...
    days: [
      {
        dayLabel: "Pull-Up Bar Specialization",
        focus: "Back and grip strength with minimal equipment",
        blocks: [
          {
            label: "Warm-up",
            items: [
              { ref: "cross-body-shoulder-stretch", refKind: "stretch", holdSec: 30 },
              { ref: "wall-biceps-stretch", refKind: "stretch", holdSec: 20 },
            ],
      },
          {
            label: "Main",
            items: [
              { ref: "pull-up", refKind: "exercise", sets: 4, reps: "3-6" },
              { ref: "chin-up", refKind: "exercise", sets: 3, reps: "5-8" },
              { ref: "dead-hang", refKind: "exercise", sets: 3, restSec: 90 },
              { ref: "hanging-knee-raise", refKind: "exercise", sets: 3, reps: "8-10" },
            ],
      },
          {
            label: "Cooldown",
            items: [
              { ref: "downward-dog", refKind: "stretch", holdSec: 45 },
              { ref: "childs-pose", refKind: "stretch", holdSec: 60 },
            ],
      },
        ],
        totalMin: 15,
